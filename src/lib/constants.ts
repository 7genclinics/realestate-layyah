...
export const NAV_ITEMS = [
  { navKey: "dashboard", href: "/dashboard", icon: "layout-dashboard" },
  { navKey: "societies", href: "/societies", icon: "building-2" },
  { navKey: "landBank", href: "/land-bank", icon: "land-plot" },
  { navKey: "inventory", href: "/inventory", icon: "map" },
  { navKey: "leads", href: "/leads", icon: "target" },
  { navKey: "customers", href: "/customers", icon: "users" },
  { navKey: "bookings", href: "/bookings", icon: "file-signature" },
  { navKey: "installments", href: "/installments", icon: "calendar-clock" },
  { navKey: "receipts", href: "/receipts", icon: "receipt" },
  { navKey: "cashBook", href: "/cash-book", icon: "book-open" },
  { navKey: "parties", href: "/parties", icon: "handshake" },
  { navKey: "development", href: "/development", icon: "hammer" },
  { navKey: "agents", href: "/agents", icon: "briefcase" },
  { navKey: "staff", href: "/staff", icon: "id-card" },
  { navKey: "approvals", href: "/approvals", icon: "clipboard-check" },
  { navKey: "documents", href: "/documents", icon: "file-stack" },
  { navKey: "reports", href: "/reports", icon: "chart-column" },
  { navKey: "audit", href: "/audit", icon: "history" },
